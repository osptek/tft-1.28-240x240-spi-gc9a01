...
<p align="center"><img alt="OSPTEK 1.28 inch 240×240 TFT SPI module (GC9A01) product image" src="./images/product.png" width="640" /></p>
...
Current module version: **YDP128H004-V3**. Electrical and mechanical details follow [`docs/YDP128H004-V3.pdf`](./docs/YDP128H004-V3.pdf).
...
└── versions/
    └── YDP128H004-V3/                      # full materials for this part number
        ├── README.md
        ├── README_EN.md
        ├── images/
        ├── docs/
...
| Resource | Link |
| ---- | ---- |
| Product datasheet (YDP128H004-V3) | [`docs/YDP128H004-V3.pdf`](./docs/YDP128H004-V3.pdf) |
