...
当前模组版本：**YDP128H011-V3**。电气与外形细节以 [`docs/YDP128H011-V3.pdf`](./docs/YDP128H011-V3.pdf) 为准。
...
| 资料 | 链接 |
| ---- | ---- |
| 产品规格书（YDP128H011-V3） | [`docs/YDP128H011-V3.pdf`](./docs/YDP128H011-V3.pdf) |
