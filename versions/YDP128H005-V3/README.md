...
<p align="center"><b>圆形 TFT · SPI · GC9A01</b></p>
...
OSPTEK **1.28 寸 240×240 TFT** 是一款 **4-line SPI** 接口圆形彩色显示模组，驱动为 **GC9A01**。

规格标识（仓库名）：`tft-1.28-240x240-spi-gc9a01`

当前模组版本：**YDP128H005-V3**。电气与外形细节以 [`docs/YDP128H005-V3.pdf`](./docs/YDP128H005-V3.pdf) 为准。
...
| 资料 | 链接 |
| ---- | ---- |
| 产品规格书（YDP128H005-V3） | [`docs/YDP128H005-V3.pdf`](./docs/YDP128H005-V3.pdf) |
