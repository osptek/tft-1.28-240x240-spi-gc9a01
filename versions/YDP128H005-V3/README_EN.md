...
Current module version: **YDP128H005-V3**. Electrical and mechanical details follow [`docs/YDP128H005-V3.pdf`](./docs/YDP128H005-V3.pdf).
...
└── versions/
    └── YDP128H005-V3/                      # full materials for this part number
        ├── README.md
        ├── README_EN.md
        ├── images/
        ├── docs/
...
| Resource | Link |
| ---- | ---- |
| Product datasheet (YDP128H005-V3) | [`docs/YDP128H005-V3.pdf`](./docs/YDP128H005-V3.pdf) |
